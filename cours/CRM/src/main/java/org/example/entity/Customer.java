...
public class Customer {
    ...
    private Payment payment; // numero de carte bancaire et non une transaction

    @ManyToOne
    @JoinColumn(name="delivery_address")
    private  Address deliveryAddress; // 1 addresse pour plusieurs customers ou plusieurs clients pour une adresse
